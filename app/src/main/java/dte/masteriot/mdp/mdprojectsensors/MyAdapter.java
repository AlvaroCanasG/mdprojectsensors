...
public class MyAdapter extends RecyclerView.Adapter<dte.masteriot.mdp.mdprojectsensors.MyViewHolder> {
    ...
    @Override
    public dte.masteriot.mdp.mdprojectsensors.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new dte.masteriot.mdp.mdprojectsensors.MyViewHolder(context, v, this);
    }
